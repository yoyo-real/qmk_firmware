...
#    if defined(LED_MATRIX_ENABLE) && defined(LED_MATRIX_SPLIT)
    ...
    i2c_writeReg(SLAVE_I2C_ADDRESS, I2C_LED_SUSPEND_START, (void *)&suspend_state, sizeof(suspend_state), TIMEOUT);
#    endif
#    if defined(RGB_MATRIX_ENABLE) && defined(RGB_MATRIX_SPLIT)
    i2c_writeReg(SLAVE_I2C_ADDRESS, I2C_RGB_MATRIX_START, (void *)&rgb_matrix_config, sizeof(i2c_buffer->rgb_matrix), TIMEOUT);
    bool suspend_state = rgb_matrix_get_suspend_state();
    i2c_writeReg(SLAVE_I2C_ADDRESS, I2C_RGB_SUSPEND_START, (void *)&suspend_state, sizeof(suspend_state), TIMEOUT);
#    endif
