...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { 
    [_BASE] = LAYOUT( /* Base */ 
        ...
        KC_LSFT, KC_Z,  KC_X,  KC_C,  KC_V,  KC_B ,  KC_N,  KC_M,  KC_COMM,KC_DOT,KC_SLSH, KC_BSLS,  KC_BSPC,
                     KC_LALT, TT(_CTRL_NUMPAD),  KC_SPC  ,  LT(_RAISE, KC_ENT),  KC_RSFT,  KC_RWIN 
        ),
    [_RAISE] = LAYOUT(
    ...
    [_CTRL_NUMPAD] = LAYOUT(
        KC_GRV, _______, _______, _______, _______, _______  ,  KC_TAB , KC_PSLS, KC_PAST, KC_BSPC, _______, _______, _______,
