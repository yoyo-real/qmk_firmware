...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { 
    [_BASE] = LAYOUT( /* Base */ 
        ...
        KC_LCTL,KC_A,  KC_S,  KC_D,  KC_F,  KC_G ,  KC_H,  KC_J,  KC_K,  KC_L,  KC_SCLN,  KC_QUOT,  KC_NO,
        KC_LSFT, KC_Z,  KC_X,  KC_C,  KC_V,  KC_B ,  KC_N,  KC_M,  KC_COMM,KC_DOT,KC_SLSH, KC_BSLS,  KC_BSPC,
                     KC_LWIN, KC_LALT, LT(_LOWER, KC_SPC)  ,  LT(_RAISE, KC_ENT),  KC_RSFT,  TT(_NUMPAD) 
        ),
    [_RAISE] = LAYOUT(
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, _______, LCTL(KC_W), _______, LCTL(KC_R), LCTL(KC_T)  ,  _______, _______, _______, _______, _______, _______, _______,
        _______, LCTL(KC_A), LCTL(KC_S), _______, LCTL(KC_TAB), _______  ,  _______, _______, _______, _______, _______, _______, _______,
        _______, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), _______  ,  _______, _______, _______, _______, _______, _______, _______,
